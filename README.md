[![REUSE status](https://api.reuse.software/badge/github.com/SAP-docs/btp-cloud-logging)](https://api.reuse.software/info/github.com/SAP-docs/btp-cloud-logging)

# Contributions to the SAP Cloud Logging documentation

Found a mistake in our documentation? Always wanted to add a step in one of our procedures that could save many others much time? Then you're at the right place! All contributions made to the Markdown files in the [docs](docs) directory are reviewed, and if deemed valuable be added to our [official documentation on SAP Help Portal](https://help.sap.com/docs/cloud-logging/cloud-logging/what-is-sap-cloud-logging). The easiest way is to start there, and choose _Edit_ to find the right Markdown file to contribute to.
...
We recommend using the SAP Cloud Logging documentation on SAP Help Portal as a starting point for contributions:

1. Open the [SAP Cloud Logging documentation](https://help.sap.com/docs/cloud-logging/cloud-logging/what-is-sap-cloud-logging).
1. You can either:
